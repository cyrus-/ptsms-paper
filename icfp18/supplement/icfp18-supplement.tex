...
\usepackage[colorlinks=true,allcolors=Blue,pageanchor=true,plainpages=false, pdfpagelabels, bookmarks,bookmarksnumbered,
...
\abstract{
This report presents a complete technical account of the formal system that was described in the accompanying paper \cite{tlms-icfp18}, as well as more details on the quasiquotation TLM.
}
...
supported in part by AFRL and DARPA under agreement \#FA8750-16-2-0042 and 
 by the NSA under lablet contract \#H98230-14-C-0140.}
